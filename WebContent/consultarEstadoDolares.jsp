...
<body style="width: 472px; height: 520px; ">
	<fieldset style="text-align: left; width: 381px; height: 541px">
		<legend style="width: 296px; ">Consultar estado de cuenta en dólares:</legend>
		<form action="ServletEstadoCuentaDolares" method="post" style="width: 375px; height: 339px">
