...
<body style="width: 409px; height: 376px; ">
	<center class="vertical-menu" style="width: 321px; height: 238px; visibility: visible; top: auto; left: auto; bottom: auto; position: absolute; right: auto">
		...
		<a href="depositoColones.jsp" style="font-family: Arial, Helvetica, sans-serif;">Consultar estatus de cuenta. </a>
		<a href="depositoColones.jsp" style="font-family: Arial, Helvetica, sans-serif;">Módulo de bitácora. </a>
	</center>
</body>
</html>