 ...
 */
@WebServlet("/ServletEstadoCuentaColones")
public class ServletEstadoCuentaColones extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletEstadoCuentaColones() {
        super();
		...
		try 
		{
			if(con.selectEstatus(cuentaInt).equals("activa"))
			{
				...
				{			        
					...
					if(cuenta_consult != 0)
					{	
						ConsultaEstadoCuenta consulta = new ConsultaEstadoCuenta(cuentaInt, pinEncriptado);
